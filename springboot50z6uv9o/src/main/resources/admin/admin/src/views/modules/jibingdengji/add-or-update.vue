	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="病猪数量" prop="bingzhushuliang" >
					<el-input v-model="ruleForm.bingzhushuliang" placeholder="病猪数量" clearable  :readonly="ro.bingzhushuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="病猪数量" prop="bingzhushuliang" >
					<el-input v-model="ruleForm.bingzhushuliang" placeholder="病猪数量" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="处理方法" prop="chulifangfa" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="处理方法"
					v-model="ruleForm.chulifangfa" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.chulifangfa" label="处理方法" prop="chulifangfa" >
				<span class="text">{{ruleForm.chulifangfa}}</span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.chulijieguo" label="处理结果" prop="chulijieguo" >
				<span class="text">{{ruleForm.chulijieguo}}</span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='bingzhushuliang'){
							this.ruleForm.bingzhushuliang = obj[o];
							this.ro.bingzhushuliang = true;
							continue;
						}
						if(o=='chulifangfa'){
							this.ruleForm.chulifangfa = obj[o];
							this.ro.chulifangfa = true;
							continue;
						}
						if(o=='chulijieguo'){
